...
LIBS      = -lboost_system -lboost_thread -lboost_math_c99 -lboost_regex -lopenal -lmp3lame -lpthread -lrtmidi -lboost_log -lboost_log_setup -lboost_program_options -lboost_filesystem -lboost_date_time
